...
def aggregate_scores(psnr_files, ssim_files):
    ...
    for psnr_file, ssim_file in zip(psnr_files, ssim_files):
        ...
        for label, psnr_score, ssim_score in zip(psnr_labels, psnr_scores, ssim_scores):
            ...
            aggregated_ssim_scores[second_number].append(ssim_score)
...
def calculate_overall_best(psnr_files, ssim_files):
    ...
    # Calculate mean scores for each second number
...
def plot_overall_scores(overall_scores, output_path):
    ...
    plt.title('Overall Normalized Scores for Different Second Numbers in Labels', fontsize=16)
...
# Example usage
psnr_files = [
    r"C:\Users\rausc\Documents\EMBL\data\nema-results\psnr_scores-nema-3D-single-2.txt",
    r"C:\Users\rausc\Documents\EMBL\data\droso-results\psnr_scores-droso-3D-single-2.txt",
    r"C:\Users\rausc\Documents\EMBL\data\mouse-results\psnr_scores-mouse-3D-single-2.txt"
    # Add more PSNR file paths as needed
]
ssim_files = [
    r"C:\Users\rausc\Documents\EMBL\data\nema-results\ssim_scores-nema-3D-single-2.txt",
    r"C:\Users\rausc\Documents\EMBL\data\droso-results\ssim_scores-droso-3D-single-2.txt",
    r"C:\Users\rausc\Documents\EMBL\data\mouse-results\ssim_scores-mouse-3D-single-2.txt"
...
output_path = r"C:\Users\rausc\Documents\EMBL\data\general-results\3D-single-overall-width.png"
