...
def plot_psnr_scores_boxplot_with_half_box_and_scatter(all_psnr_scores, labels, output_dir, plot_filename, sensitivity=1.5, dpi=100, font_size=12, line_thickness=1.5):
...
if __name__ == "__main__":
    ...
    plot_filename = 'psnr_scores-comp-single-1.png'
    ...
    sensitivity = 10000  # Adjust this value to change the outlier sensitivity
    ...
    plot_psnr_scores_boxplot_with_half_box_and_scatter(all_psnr_scores, custom_labels, output_dir, plot_filename, sensitivity, dpi, font_size, line_thickness)
