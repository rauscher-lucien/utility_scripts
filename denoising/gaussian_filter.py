...
def gaussian_filter_3d_image_stack(image_stack, sigma, test_index=None):
    ...
    if test_index is not None:
        ...
        filtered_test_slice = gaussian_filter(test_slice, sigma=sigma)
    ...
    for i, slice in enumerate(image_stack):
        ...
        filtered_slice = gaussian_filter(slice_float, sigma=sigma)
...
def save_filtered_stack(filtered_stack, input_path):
    ...
    output_filename = f"{name}_filtered_gaussian_5{ext}"
